...
function bannerListFn(a,b,c,d,e,f){
    ...
    function imgListBtn (){
        ...
        $imgBtnList.children().click(function(){
            ...
            size=index;
            bannerImgList(index);
            $imgBtnList.children().eq(size).addClass("current").siblings().removeClass("current");
    ...
    function move(){
        ...
        (size == liLength-1) ? $imgBtnList.children().eq(0).addClass("current").siblings().removeClass("current") : $imgBtnList.children().eq(size).addClass("current").siblings().removeClass("current");

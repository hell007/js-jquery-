...
(function() {
		...
		init: function() {
			...
			var l = {
					...
					Scene: e.extend(function(t) {
						...
						render: function() {
							//障碍物设置
							e.canvas.fillStyle("red").fillRect(this.x, this.baseY - 5, this.width, 5);
							for(var t = this.boxes.length - 1, n; n = this.boxes[t]; t--) e.canvas.drawImage("package", n.x, n.y);
							//for(var t = this.boxes.length - 1, n; n = this.boxes[t]; t--) e.canvas.fillStyle("green").fillRect(n.x, n.y, n.width, n.height);
	...
	e.init(window.innerWidth, window.innerHeight).pushImage([{
		...
		id:"package",
		src:"http://www.kunyujie.com/static/favicon.ico"}], function(e, t, n) {}).initAudio([{
		id: "1",
		src: "sound/1.mp3",
		preload: !0
